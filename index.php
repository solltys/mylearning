...
<html lang="en">
    ...
    <body>
        <nav>
           <div class="navbar">
            <a href="index.php"><img id="logo" src="/Assets/Logo.png" alt="My Logo Image"></a>
        ...
        <main> 
            <menu>
                    <div class="sidebar">
                        ...
                        <ul>
                            <li class="chapter"><a href="#" id="A:Introduction">Introduction</a></li>
                            <li class="chapter"><a href="#" id="Chapter1">Chapter 1: Variables, Expressions and</br>Operators</a></li>
