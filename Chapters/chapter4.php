...
$savings = new Account(12546222, 'Savings', 852.00);
$current = new Account(256985, 'Current', 85.00);
$investment = new Account(25879666,'Investment', 25000.00);
...
<main>
    ...
    <div class="main chapter4">
        ...
        <tr>
            <td>24 June</td>
            <td><?= $current->deposit(26.00) ?></td>
            <td><?= $savings->withdrawal(250.00) ?></td>
        </tr>
        <tr>
            <td>25 June</td>
            <td><?= $current->withdrawal(6.00) ?></td>
            <td><?= $savings->deposit(100.00) ?></td>
        </tr>
        </table>
        <h2><?= $investment->type ?> Account</h2>
        <p>Previous Balance € <?= $investment->getBalance() ?></p>
        <p>Withdrawal €<?= $investment->withdrawal(50.00) ?></p>
        <p>Deposit €<?= $investment->deposit(2500.00) ?></p>
        <p>New Balance €<?= $investment->getBalance() ?></p>
    </div>
</main>
